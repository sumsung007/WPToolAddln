    ...
    class _2017Olds
    {
        public static void 报表填写()
        {
            if (CU.文件判断())
            {
                ...
                if ((WorkingPaper.Wb.Sheets["余额表"].Range["A2"] != null) &&
                    ...
                    (MessageBox.Show("是否填写报表？", "提示", MessageBoxButtons.YesNo) == DialogResult.Yes))
                {
                    if ((WorkingPaper.Wb.Sheets["基本情况"].Cells[8, 2].Value == "中汇百邦（厦门）税务师事务所有限公司" &&
                        ...
                        (WorkingPaper.Wb.Sheets["基本情况"].Cells[8, 2].Value == "中汇（厦门）税务师事务所有限公司" &&
                         WorkingPaper.Wb.Sheets["档案封面"].Cells[6, 1].Value == "中汇（厦门）税务师事务所有限公司" &&
                         WorkingPaper.Wb.Sheets["基本情况（封面）"].Cells[16, 2].Value == "中汇（厦门）税务师事务所有限公司") ||
                         ...
                         WorkingPaper.Wb.Sheets["基本情况（封面）"].Cells[16, 2].Value == "厦门明正税务师事务所有限公司"))
                    {
                        try
                        {
                            ...
                            WorkingPaper.Wb.Sheets["资产负债"].Range["C5:D18,C21:D24,C26:D33,G5:H14,G21:H24,G30:H33"]
                                .Value = "";
                            WorkingPaper.Wb.Sheets["利润"].Range["C5:D26,C28:D36,C38:D38,G6:H6,H7,G8:H10,G12:H18,G20:H21"]
                                .Value = "";
                            Worksheet SH = WorkingPaper.Wb.Sheets["余额表"];
                            int N = SH.Cells[SH.UsedRange.Rows.Count + 1, 2].End[XlDirection.xlUp].Row;
                            int changdu = (int) WorkingPaper.Wb.Sheets["余额表"].Range["o2"].Value;
                            ...
                            WorkingPaper.Wb.Sheets["资产负债"].Range["C5:D18"].Value2 = ldzc;
                            ...
                            ldzc[3, 0] = qc[30]; //累计折旧
                            ldzc[3, 1] = qm[30];
                            WorkingPaper.Wb.Sheets["资产负债"].Range["C21:D24"].Value2 = ldzc;
                            ...
                            ldzc[6, 1] = qm[37];
                            WorkingPaper.Wb.Sheets["资产负债"].Range["C26:D32"].Value2 = ldzc;
                            ...
                            ldzc[9, 1] = qm[49];
                            WorkingPaper.Wb.Sheets["资产负债"].Range["G5:H14"].Value2 = ldzc;
                            ...
                            WorkingPaper.Wb.Sheets["资产负债"].Range["G21:H22"].Value2 = ldzc;
                            ...
                            WorkingPaper.Wb.Sheets["资产负债"].Range["G30:H33"].Value2 = ldzc;
                            ...
                            WorkingPaper.Wb.Sheets["利润"].Range["C5:C26"].Value2 = ldzc;

                            ldzc = new double[3, 1];
                            ldzc[0, 0] = lrb[9]; //营业外收入
                            ldzc[2, 0] = lrb[10]; //营业外支出
                            WorkingPaper.Wb.Sheets["利润"].Range["C28:C30"].Value2 = ldzc;

                            WorkingPaper.Wb.Sheets["利润"].Cells[38, 3].Value = lrb[11]; //所得税
                        ...
                        if (CU.Shuzi(WorkingPaper.Wb.Sheets["资产负债"].Range["H38"].Value2) != 0)
                        {
                            MessageBox.Show("报表填写完毕，请复查!" + "资产负债表未分配利润期末余额与利润表期末未分配利润差异" +
                                            CU.Shuzi(WorkingPaper.Wb.Sheets["资产负债"].Range["H38"].Value2).ToString("N"));
                        }
                        else
